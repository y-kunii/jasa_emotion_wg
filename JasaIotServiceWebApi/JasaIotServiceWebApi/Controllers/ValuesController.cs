...
//            ThingsCommandList.THING_OEL_ON,         // 有機EL を ON
            ThingsCommandList.THING_OEL_YELLOW2,    // 有機EL を黄色30%
...
//            ThingsCommandList.THING_OEL_100,        // 有機EL を 100%
        ...
        // デバッグ用
        private string[] DEBUG_COMMANDS =
        {
//            ThingsCommandList.THING_OEL_BLUE,         // 有機EL カラー灯 青
            ThingsCommandList.THING_OEL_DARKYELLOW,     // 有機EL カラー灯 暗い黄色
            ThingsCommandList.THING_NULL                // コマンド終了
        };
        /// ///////////////////////////////////////////////////////////////////
...
//            request.RedgeId = "0f86d341-66af-46be-81d4-beae76a962cb";   // 吉栖スマホ2
        ...
        public void Post([FromBody]string value)
        {
            switch (value)
            {
                ...
                case CommandConst.REQ_GETUP:         // 覚醒（離床）
                    ...
                    break;
                case CommandConst.REQ_DEBUG:          // デバッグ用
                    DoCommand(DEBUG_COMMANDS);
                    break;
        ...
        public void Put(int id, [FromBody]string value)
        {
            switch (id)
            {
                ...
                case CommandConst.REQID_GETUP:         // 覚醒（離床）
                    DoCommand(GETUP_COMMANDS);
                    break;
                case CommandConst.REQID_DEBUG:          // デバッグ用
                    DoCommand(DEBUG_COMMANDS);
                    break;
                default:                // その他のコマンドを受けた時は、何もしない。
                    break;
        ...
        private void DoCommand(string[] commands)
        {
            ...
            do
            {
                ...
                requests.requestList[0].RedgeId = "78f92ebe-d7de-4388-80eb-946d828a29af";   // JASAスマホ
//                requests.requestList[0].RedgeId = "1bf66a08-e704-4a67-b1c6-b5e7903cd571";   // 吉栖スマホ1
//                requests.requestList[0].RedgeId = "0f86d341-66af-46be-81d4-beae76a962cb";   // 吉栖スマホ2
