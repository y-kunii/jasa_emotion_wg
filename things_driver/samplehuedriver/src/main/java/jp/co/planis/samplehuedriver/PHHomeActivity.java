...
import jp.co.planis.samplehuedriver.data.AccessPointListAdapter;
...
public class PHHomeActivity extends Activity implements OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HueController.getInstance().sendDriverInfo(this);
        ...
        editTextIpAddress.setText(lastIpAddress);
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                prefs.setLastConnectedIPAddress(editTextIpAddress.getText().toString());
                prefs.setUsername(editTextUserName.getText().toString());
                startMainActivity();
            }
        });
